...
const Register = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-orange-50 relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-4 py-6 lg:py-8">
        <div className="text-center mb-6 animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto mb-6">
            <div className="bg-white/60 backdrop-blur-sm p-3 rounded-xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <Card className="w-full max-w-3xl mx-auto bg-white/90 backdrop-blur-sm border-0 shadow-xl animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <CardHeader className="text-center pb-4 pt-6">
            ...
            <CardDescription className="text-sm text-gray-600 max-w-xl mx-auto">
              Escolha seu tipo de conta e comece a aproveitar todos os benefícios da nossa plataforma
            </CardDescription>
          </CardHeader>
          <CardContent className="px-6 pb-6">
            <Tabs defaultValue="workshop" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-6 h-10 bg-gray-100/80 backdrop-blur-sm rounded-xl p-1">
                <TabsTrigger 
                  value="workshop" 
                  className="text-sm py-2 px-3 rounded-lg font-semibold transition-all duration-300 data-[state=active]:bg-blue-600 data-[state=active]:text-white data-[state=active]:shadow-md"
                >
                ...
                <TabsTrigger 
                  value="driver" 
                  className="text-sm py-2 px-3 rounded-lg font-semibold transition-all duration-300 data-[state=active]:bg-orange-500 data-[state=active]:text-white data-[state=active]:shadow-md"
                >
              ...
              <TabsContent value="workshop" className="space-y-4 animate-fade-in">
                <div className="text-center mb-4">
                  <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-3 rounded-xl mb-3">
                    <Wrench className="h-6 w-6 text-blue-700 mx-auto mb-2" />
                    <h3 className="text-lg font-bold text-blue-900 mb-1">Cadastro de Oficina</h3>
                    <p className="text-blue-700 text-sm">Registre sua oficina e comece a receber clientes hoje mesmo</p>
                  </div>
                </div>
                <WorkshopForm />
              </TabsContent>
              ...
              <TabsContent value="driver" className="space-y-4 animate-fade-in">
                <div className="text-center mb-4">
                  <div className="bg-gradient-to-r from-orange-100 to-orange-200 p-3 rounded-xl mb-3">
                    <User className="h-6 w-6 text-orange-700 mx-auto mb-2" />
                    <h3 className="text-lg font-bold text-orange-900 mb-1">Cadastro de Motorista</h3>
                    <p className="text-orange-700 text-sm">Encontre as melhores oficinas e cuide do seu veículo</p>
                  </div>
                </div>
                <DriverForm />
              </TabsContent>
        ...
        <div className="mt-8 text-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 opacity-60">
            <div className="bg-white/60 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg border border-white/20">
