    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-orange-50 relative overflow-hidden mobile-scroll pb-16 md:pb-0">
      ...
      <div className="relative max-w-4xl mx-auto px-4 py-6 md:py-8 lg:py-12">
        <div className="text-center mb-6 md:mb-8 animate-fade-in">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed mb-4 md:mb-6 px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 max-w-3xl mx-auto mb-6 md:mb-8 px-4">
            <div className="bg-white/60 backdrop-blur-sm p-3 md:p-4 rounded-xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="bg-white/60 backdrop-blur-sm p-3 md:p-4 rounded-xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <Clock className="h-5 w-5 md:h-6 md:w-6 text-orange-600 mx-auto mb-2" />
            ...
            <div className="bg-white/60 backdrop-blur-sm p-3 md:p-4 rounded-xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <Star className="h-5 w-5 md:h-6 md:w-6 text-green-600 mx-auto mb-2" />
              ...
              <TabsContent value="workshop" className="space-y-4 md:space-y-6 animate-fade-in">
                <div className="text-center mb-4 md:mb-6">
                  <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-3 md:p-4 rounded-xl mb-4">
                    ...
                    <p className="text-sm md:text-base text-blue-700">Registre sua oficina e comece a receber clientes hoje mesmo</p>
                  </div>
                </div>
                <WorkshopForm />
              </TabsContent>
              ...
              <TabsContent value="driver" className="space-y-4 md:space-y-6 animate-fade-in">
                <div className="text-center mb-4 md:mb-6">
                  <div className="bg-gradient-to-r from-orange-100 to-orange-200 p-3 md:p-4 rounded-xl mb-4">
                    ...
                    <p className="text-sm md:text-base text-orange-700">Encontre as melhores oficinas e cuide do seu veículo</p>
                  </div>
                </div>
                <DriverForm />
              </TabsContent>
        ...
        <div className="mt-8 md:mt-12 text-center animate-fade-in px-4" style={{
          animationDelay: '0.4s'
        }}>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 opacity-60">
            <div className="bg-white/60 backdrop-blur-sm px-4 py-2 md:px-6 md:py-3 rounded-lg shadow-lg border border-white/20">
              <div className="text-gray-500 font-semibold text-xs md:text-sm">Parceiro Confiável</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm px-4 py-2 md:px-6 md:py-3 rounded-lg shadow-lg border border-white/20">
              <div className="text-gray-500 font-semibold text-xs md:text-sm">Certificado SSL</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm px-4 py-2 md:px-6 md:py-3 rounded-lg shadow-lg border border-white/20">
              <div className="text-gray-500 font-semibold text-xs md:text-sm">LGPD Compliant</div>
            </div>
          </div>
        </div>
      </div>
