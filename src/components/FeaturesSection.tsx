...
import { Car, Calendar, FileText, Clock, Star, CheckCircle, Settings, Users, MapPin, ArrowRight } from 'lucide-react';
const FeaturesSection = () => {
  ...
  const FeatureCard = ({
    ...
    description,
    index
  }) => <Card className="h-full group hover:shadow-2xl transition-all duration-500 border-gray-200 hover:border-orange-300 hover:-translate-y-2 bg-white overflow-hidden animate-fade-in" style={{
  ...
  return <section className="py-20 bg-gradient-to-b from-gray-50 to-white lg:py-[50px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Motoristas Section */}
        <div id="motoristas" className="mb-24">
          <div className="text-center mb-16 animate-fade-in">
            <div className="inline-flex items-center bg-blue-100 text-blue-800 py-2 rounded-full text-sm font-medium mb-4 px-[40px]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {motoristaFeatures.map((feature, index) => <FeatureCard key={index} {...feature} index={index} />)}
          </div>
        </div>
        ...
        <div id="oficinas">
          <div className="text-center mb-16 animate-fade-in">
            <div className="inline-flex items-center bg-orange-100 text-orange-800 py-2 rounded-full text-sm font-medium mb-4 px-[40px]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {oficinaFeatures.map((feature, index) => <FeatureCard key={index} {...feature} index={index} />)}
          </div>
        </div>
      </div>
    </section>;
