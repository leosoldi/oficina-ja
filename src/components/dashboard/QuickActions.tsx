  ...
  return (
    <div className="mb-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <Link to="/workshop/cadastro-cliente">
          <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer group">
            <CardContent className="p-3 sm:p-4 text-center">
              <UserPlus className="h-6 w-6 sm:h-8 sm:w-8 text-green-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
              <p className="text-xs sm:text-sm font-medium text-gray-700">Cadastro Cliente</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link to="/workshop/checklists">
          <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer group">
            <CardContent className="p-3 sm:p-4 text-center">
              <CheckCircle className="h-6 w-6 sm:h-8 sm:w-8 text-purple-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
              <p className="text-xs sm:text-sm font-medium text-gray-700">Checklist</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link to="/workshop/perfil">
          <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer group">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-sm font-medium text-gray-700">Perfil Oficina</p>
            </CardContent>
          </Card>
        </Link>
      </div>
