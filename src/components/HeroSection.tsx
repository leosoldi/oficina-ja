        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center space-y-8 lg:space-y-0">
          ...
          <div className="space-y-6 md:space-y-8 animate-fade-in text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 max-w-sm mx-auto lg:mx-0 lg:max-w-none">
              ...
              <Button asChild variant="outline" size="lg" className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm px-6 md:px-8 py-3 md:py-4 text-base md:text-lg shadow-xl transform hover:scale-105 transition-all duration-300 touch-target">
                ...
                <div className="space-y-2">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button variant="outline" className="w-full h-11 md:h-12 bg-white/20 text-white border-white/30 rounded-xl justify-between hover:bg-white/25 backdrop-blur-sm focus:border-orange-400 transition-all duration-300 text-base touch-target">
