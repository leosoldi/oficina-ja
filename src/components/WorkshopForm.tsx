  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              className={`pl-10 h-11 md:h-12 ${errors.workshopName ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'}`} 
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              className={`pl-10 h-11 md:h-12 ${errors.cnpj ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'}`} 
              {...register('cnpj', {
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              className={`pl-10 h-11 md:h-12 ${errors.ownerName ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'}`} 
              {...register('ownerName', {
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              className={`pl-10 h-11 md:h-12 ${errors.phone ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'}`} 
              {...register('phone', {
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input 
            ...
            className={`pl-10 h-11 md:h-12 ${errors.email ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'}`} 
            {...register('email', {
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input 
            ...
            className={`pl-10 h-11 md:h-12 ${errors.address ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'}`} 
            {...register('address', {
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Textarea 
            ...
            className={`pl-10 pt-3 min-h-[80px] md:min-h-[100px] resize-none ${errors.services ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'}`} 
            {...register('services', {
              required: 'Descrição dos serviços é obrigatória'
            })} 
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              className={`pl-10 h-11 md:h-12 ${errors.password ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'}`} 
              {...register('password', {
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              className={`pl-10 h-11 md:h-12 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'}`} 
      ...
      <Button 
        ...
        className="w-full bg-blue-800 hover:bg-blue-900 text-white py-3 md:py-4 text-base md:text-lg font-medium transition-colors h-12 md:h-14"
      >
